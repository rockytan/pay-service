...
# Database: ace_admin
# Generation Time: 2016-09-14 07:01:43 +0000
# ************************************************************
...
INSERT INTO `permission` (`id`, `code`, `depth`, `description`, `name`, `path`, `status`, `url`, `version`, `parent_id`, `type`, `created_time`, `creator`, `is_delete`, `modified_time`, `modifier`, `sort`, `icon`)
VALUES
	('1','ALL',0,'ALL','ALL','1,',0,'',1,NULL,1,NULL,NULL,0,NULL,NULL,0,NULL),
	('2','dashboard',1,'概览','概览','2,',0,'index.html',0,NULL,0,NULL,NULL,0,NULL,NULL,30,'fa-tachometer'),
	('3','system',1,'系统设置','系统设置','3,',0,NULL,0,NULL,0,NULL,NULL,0,NULL,NULL,200,'fa-cogs'),
	('4','menu',2,'菜单管理','菜单管理','3,4,',0,'system/menu.html',NULL,'3',0,NULL,NULL,0,NULL,NULL,30,'glyphicon-list');
